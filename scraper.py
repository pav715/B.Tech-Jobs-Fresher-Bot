...
# South India + Remote — must accept every city/state in config.LOCATIONS,
# plus common aliases (Bangalore/Bengaluru, Kochi/Cochin, Vizag, WFH, etc.)
LOCATION_PATTERN = re.compile(
    r"""
    \b(
      hyderabad | hyd | telangana | secunderabad | cyberabad
    | bangalore | bengaluru | karnataka
    | chennai | coimbatore | tamil\s*nadu
    | kochi | cochin | thiruvananthapuram | trivandrum | kerala
    | visakhapatnam | vizag | vijayawada | andhra\s*pradesh
    | remote | work\s*from\s*home | wfh | india
    )\b
    """,
    re.IGNORECASE | re.VERBOSE,
)
